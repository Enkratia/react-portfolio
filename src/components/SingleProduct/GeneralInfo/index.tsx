...
type GeneralInfoLeftProps = {
  product: ProductType;
  pathname: string;
};

const GeneralInfoLeft: React.FC<GeneralInfoLeftProps> = ({ product, pathname }) => {
          ...
          {product.imageUrls.map((imageUrl, i) => (
            <div
              ...
              <div className={s.miniSliderImageWrapper}>
                <img src={imageUrl} alt="Product mini-slide image." className={s.miniSliderImage} />
              </div>
            </div>
          ))}
...
const GeneralInfoRight: React.FC<GeneralInfoRightProps> = ({
  product,
  pathname,
  selectRef,
  reviewsCount,
    ...
    <div className={s.right}>
      <div className={s.details}>
        ...
        <div className={`${pr.prices} ${s.prices}`}>
          <span className={`${pr.price} ${pr.priceLg} ${product.oldPrice > 0 ? pr.priceRed : ""}`}>
                    ...
                    {selectSizes.length > 1 &&
                      selectSizes.map((size, i) => (
                        <li
                          key={i}
                          tabIndex={0}
                          className={`${cs.selectItem} ${spSize === i ? cs.selectItemActive : ""}`}
                          role="option"
      ...
      <div className={s.accordion}>
        ...
        <div className={s.accordionBottom} id="general-accordion-0">
          <p className={s.accordionDescr}>
            Free standard shipping on orders <b className={s.accordionDescrBold}>over $35</b> before
      ...
      <div className={s.accordion}>
        ...
        <div className={s.accordionBottom} id="general-accordion-1">
          <p className={`${s.accordionDescr} ${s.accordionDescrMargin}`}>
            You have <b className={s.accordionDescrBold}>60 days</b> to return the item(s) using any
...
export const GeneralInfo: React.FC<GeneralInfoProps> = ({
  ...
  return (
    <div
      ...
      id="single-product-0"
      role="tabpanel">
      <GeneralInfoLeft product={product} pathname={pathname} />
